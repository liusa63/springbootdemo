...
import com.example.demo.mongodb.MongoTesUser;
...
public class MongDBTest {
	...
	/**
	 * --------------- update ------------------------ 没有符合条件的就创建该数据
	 * mongoTemplate.upsert(query, update, CLAZZ.class);
	 * 
	 * 累加 update.inc() 删除key update.unset("tags") 删除数组中的某个数据 update.pull("tags",
	 * "java") 修改key的名称 update.rename("tags","tagArray") -------------------- query
	 * ----------------------------- in(); 小于 lt(); 大于 gt(); 不等于 ne(); 模糊查询 regex();
	 * 
	 * or();
	 * 
	 */
...
//		inc();
	...
	public void query() {
		...
		// ObjectId("5cb589b40a158532dc8e2998"),MongoTesUser.class);
		...
		List<MongoTesUser> usersLt = mongoTemplate.find(queryLt, MongoTesUser.class);
	...
	public void insert() {
		 ...
		 * 
		 * 
		 * { "_id" : ObjectId("5cb589b40a158532dc8e2991"), "name" : "liusa-0", "age" :
		 * 18, "tags" : ["java", "mongodb", "spring"], "create_time" :
		 * ISODate("2019-04-16T07:52:20.075Z"), "_class" :
		 * "com.example.demo.mongodb.MongoTesUser" }
		 * 
		 * 
		 * { "_id" : ObjectId("5cb589b40a158532dc8e2992"), "name" : "liusa-1", "age" :
		 * 19, "tags" : ["java", "mongodb", "spring"], "create_time" :
		 * ISODate("2019-04-16T07:52:20.326Z"), "_class" :
		 * "com.example.demo.mongodb.MongoTesUser" }
		 */
...
//		Query query = Query.query(Criteria.where("id").is("5cb589b40a158532dc8e2995"));
		...
		/*
		 * mongoDB 中的数据 { "_id" : ObjectId("5cb589b40a158532dc8e2995"), "name" : "刘飒",
		 * "age" : 33, "tags" : ["mongodb"], "create_time" :
		 * ISODate("2019-04-16T07:52:20.398Z"), "_class" :
		 * "com.example.demo.mongodb.MongoTesUser" }
		 */
	}
	...
	public void updateMany() {
		...
		/*
		 * mongoDB 中的数据 { "_id" : ObjectId("5cb589b40a158532dc8e2999"), "name" :
		 * "刘飒many", "age" : 22, "tags" : ["java", "python", "mongodb"], "create_time" :
		 * ISODate("2019-04-16T07:52:20.496Z"), "_class" :
		 * "com.example.demo.mongodb.MongoTesUser" }
		 */
	}
	...
	public void inc() {
		...
		/*
		 * mongoDB 中的数据 { "_id" : ObjectId("5cb589b40a158532dc8e2998"), "name" :
		 * "刘飒many", "age" : 26, "tags" : ["java", "python", "mongodb"], "create_time" :
		 * ISODate("2019-04-16T07:52:20.469Z"), "_class" :
		 * "com.example.demo.mongodb.MongoTesUser" }
		 */
